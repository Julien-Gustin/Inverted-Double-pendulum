...
if __name__ == '__main__':
    ...
    print("Value function:\n",qlearning_policy.J(deterministic_domain).T)
    ...
    if show_latex:
        ...
        print(matrix_to_table(qlearning_policy.J(deterministic_domain).T, "$J_{\\mu^*}^N(x, y)$ for all $(x, y) \\in X$ in the deterministic domain; $N = " + str(N) + "$"))
    ...
    print("Value function:\n", qlearning_policy.J(stochastic_domain).T)
    print("\nPolicy:\n",qlearning_policy.Q_policy.T)

    if show_latex:
        print(matrix_to_table_string(qlearning_policy.Q_policy.T, "$\\mu^*_N$ in the stochastic domain; $N = " + str(N) + "$"))
        print(matrix_to_table(qlearning_policy.J(deterministic_domain).T, "$J_{\\mu^*}^N(x, y)$ for all $(x, y) \\in X$ in the stochastic domain; $N = " + str(N) + "$"))